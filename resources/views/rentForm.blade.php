...
@section('content')
                ...
                <div class="container">
                    <h3 class="p-3 text-center">Select Car and Customer Name to rent out car</h3>
                    <form action="{{route('rent_out')}}" method="post" >
                        @csrf
                        <div class="mb-3">
                        ...
                        <button class="btn btn-secondary">Rent Out</button>
                      </form>
                </div>
